    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white page-enter">
      ...
      <section className="px-6 pt-12 pb-8 text-center">
        ...
        <div className="max-w-xl mx-auto relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-24 py-4 rounded-2xl bg-[#141418] border border-white/10 text-base text-gray-200 placeholder-gray-500 outline-none focus:border-[#8b5cf6]/60 focus:ring-2 focus:ring-[#8b5cf6]/20 transition-all"
          />
          <button
            onClick={handleSearch}
            className="absolute right-2 top-1/2 -translate-y-1/2 px-6 py-2.5 rounded-xl bg-[#8b5cf6] hover:bg-[#7c3aed] text-sm font-medium transition-colors"
          >
            搜索
          </button>
        </div>
      ...
      <section className="px-6 pb-12">
        ...
        {!loading && !error && animeList.length === 0 && hasSearched && (
          <div className="text-center py-16 text-gray-500"><p>没有找到相关结果</p></div>
        )}
